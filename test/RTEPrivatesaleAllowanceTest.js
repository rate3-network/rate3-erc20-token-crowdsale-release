...
contract('RTEPrivatesale Allowance Test', function (accounts) {
  ...
  describe('accepting payments based on individual minimum per transaction', function () {
    beforeEach(async function () {
      ...
      await this.crowdsale.addToWhitelist(testWallet1, minimumInvestmentInWei.mul(5));
      await this.crowdsale.addToWhitelist(testWallet2, minimumInvestmentInWei.mul(5));
